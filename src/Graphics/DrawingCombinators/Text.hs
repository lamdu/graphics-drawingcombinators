...
newFTGLFont shader renderDepth size path =
    ...
    do
        ...
        return (FTGLFont font mvar shader atlas)
...
openFont size path =
    do
        ...
        lcdFont <- newFTGLFont shader TextureAtlas.LCD_FILTERING_ON size path
